...
return [
    ...
    'Powered by {yii}' => 'При поддержке {yii}',
    'Congratulations!' => 'Поздравляем!',
    'You have successfully logged in and you can start play' => 'Вы успешно вошли и можете начать играть',
    'This is the About page. You may modify the following file to customize its content:' =>
        'Это страница О нас. Вы можете изменить следующий файл для кастомизации его содержания',
    ...
    'Update Profile' => 'Редактирование Профиля',
    'Profile' => 'Профиль',
    'Back' => 'Назад',
    'Save' => 'Сохранить',
    'Note' => 'Запись',
